...
if(isset($_GET['id'])){
    ...
    ?>
    <script>window.location.href ='todo.php';</script>
    <?php
}
?>
<!doctype html>
                    ...
                    <div class="card-body">
                        <form action="edit.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $todo['todo']; ?>" name="todo" placeholder="Enter Your to do" required>
                            </div>
                            <div class="form-group">
                                <label for="todo_time">To do Time</label>
                                <input type="date" class="form-control" value="<?= $todo['todo_time']; ?>" name="todo_time" required>
                            </div>
